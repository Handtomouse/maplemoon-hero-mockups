#!/usr/bin/env python3
"""Verify the preserved Maple Moon design-system gap audit without rewriting it."""
...
EXPECTED_HASHES = {
    ...
    "visual_qa": "d8497ba286653d4f9dc301664d599397a422803e143b2b3f58fbfef37a91a25f",
}
...
def main() -> int:
    ...
    for label, path in paths.items():
        ...
        elif sha256_file(path) != EXPECTED_HASHES[label]:
    ...
    print("DESIGN_GAP_AUDIT PASS findings=40 report_ids=40 top10=10 sources=23 visual_rows=28 statuses=UNCHANGED")
