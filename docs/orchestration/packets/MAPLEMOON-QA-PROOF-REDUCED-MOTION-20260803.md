# MAPLEMOON-QA-PROOF-REDUCED-MOTION-20260803

<!-- CONTROL-PLANE:BEGIN -->
{
  "schema": "maplemoon-packet/v2",
  "packet_id": "MAPLEMOON-QA-PROOF-REDUCED-MOTION-20260803",
  ...
  "writable_paths": ["_wip/reviews/maplemoon-six-page-qa-20260803/proof-reduced-motion", "docs/orchestration/reviews/MAPLEMOON-QA-PROOF-REDUCED-MOTION-20260803.json"],
  "verify": [
  ...
  "stop": ["listed hash or HEAD drifts", "reduced motion is only inferred from static CSS", "isolated runtime cannot be established", "any website/package/source/manifest file would change"],
