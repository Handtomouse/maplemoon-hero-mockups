# Packet FOUNDER-V04-MAIN-PHOTOSHOP-20260802

<!-- CONTROL-PLANE:BEGIN -->
{
  "schema": "maplemoon-packet/v2",
  "packet_id": "FOUNDER-V04-MAIN-PHOTOSHOP-20260802",
  "candidate_id": "FOUNDER-V04-MAIN-PHOTOSHOP-CANDIDATE-20260802-001",
  "worker_thread_id": "019fa858-05c9-7631-b26e-8f5cbbf1387a",
  "phase": "FOUNDER-V04-MAIN-PHOTOSHOP",
  "state": "ready",
  "requires_visual_evidence": true,
  "objective": "Inspect the existing Main-owned founder v04 PSD at native 100 percent, make only manually evidenced Photoshop corrections, export a review PNG, create honest individual Carli and Dylan crops from verified Heros-73 pixels, and render isolated Our Story context and native QA proofs without website integration.",
  "approval": "Nate explicitly directed Main to become the sole owner of all founder-v04 Photoshop writes, QA outputs and receipts. FOUNDER-V04-BIOS-20260802 and worker 019fc243-1080-78e2-97fd-40b98688751d are superseded for ownership and may provide visual art direction only.",
  "branch": "codex-maplemoon-section-review",
  "head": "5df674a3bd7bcd0fe738fbe8929320c89b29b89c",
  "ownership": "Main thread 019fa858-05c9-7631-b26e-8f5cbbf1387a is the sole mutating owner for every writable path in this packet.",
  "readable_paths": [
  ...
  "writable_paths": [
    ...
    "docs/orchestration/reviews/FOUNDER-V04-MAIN-PHOTOSHOP-20260802.json",
  ...
  "method": [
    ...
    "Use manual Photoshop tools only where the native inspection proves a defect; do not generate, reconstruct or replace people, hair, hands or background.",
    ...
    "Create one isolated local Our Story review page and desktop/mobile proofs only after the native portrait and crop gates pass.",
  ...
  "checkpoint_path": "_wip/checkpoints/FOUNDER-V04-MAIN-PHOTOSHOP-20260802_20260802_220102_AEST",
...
This packet authorizes only isolated Main-owned Photoshop review candidates and evidence. It does not authorize website integration, reference changes or any external action.
