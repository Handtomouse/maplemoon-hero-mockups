...
| Q5 | Apparel/merch (4 apparel SKUs, cap, bucket hat) and Bath Salts — in scope for the new store? | **Client** | Changes collections and redirect map. |
...
| Q11 | Is the 19 Aug `Bites & Eclipses` → `Eclipse Bites` change **ratified**? `REGISTRY_AUTHORITY_20260819.md` says that edit "has **not** been re-pinned or ratified", and the governed 24-card accounting still keeps `Bites 2 / Eclipses 6` separate. | **Nate** | The collections plan currently encodes it as a working assumption only. |
